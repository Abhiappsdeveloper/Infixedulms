<link rel="stylesheet" href="<?php echo e(themeAsset('css/sections/sponsor.css')); ?>">

<div class="sponsor">
    <?php if(count($result)!=0): ?>
        <div class="sponsor-title text-center">
            <h4 class="fw-bold text-primary"><?php echo e(__('frontend.Our Partner')); ?></h4>
        </div>
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/snippets/components/_single_sponsor_v3.blade.php ENDPATH**/ ?>