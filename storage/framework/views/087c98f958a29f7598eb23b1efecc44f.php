<div>
    <style data-type="aoraeditor-style">
        :root {
            --system_primery_gredient1: <?php echo e($color->primary_color??'#660AFB'); ?>;
            --system_primery_gredient2: <?php echo e($color->gradient_color??'#BF37FF'); ?>;
            ...
            --font_family1: "<?php echo e(Settings('google_font_is_active') && Settings('google_font_family1') ? Settings('google_font_family1'):'Plus Jakarta Sans'); ?>", sans-serif;
            --font_family2: "<?php echo e(Settings('google_font_is_active') && Settings('google_font_family2') ? Settings('google_font_family2'):'Inter'); ?>", sans-serif;

            --fontFamily1: "<?php echo e(Settings('google_font_is_active') && Settings('google_font_family1') ? Settings('google_font_family1'):'Plus Jakarta Sans'); ?>", sans-serif;
            --fontFamily2: "<?php echo e(Settings('google_font_is_active') && Settings('google_font_family2') ? Settings('google_font_family2'):'Inter'); ?>", sans-serif;
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/components/frontend-dynamic-style-color.blade.php ENDPATH**/ ?>