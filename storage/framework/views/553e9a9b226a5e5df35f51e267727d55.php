                                                        ...
                                                        <?php $__currentLoopData = $methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div
                                                                ...
                                                                <?php elseif($gateway->method=="PayTM"): ?>
                                                                    <?php if ($__env->exists('paytm::paytm_btn',['type'=>'deposit','amount'=>$amount])) echo $__env->make('paytm::paytm_btn',['type'=>'deposit','amount'=>$amount], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                ...
                                                                <?php elseif($gateway->method == 'Authorize.Net'): ?>
                                                                    <?php if ($__env->exists('authorizenet::diposit_form',['gateway' => $gateway, 'amount' => $amount])) echo $__env->make('authorizenet::diposit_form',['gateway' => $gateway, 'amount' => $amount], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                <?php elseif($gateway->method == 'Braintree'): ?>
                                                                    <?php if ($__env->exists('braintree::disposit',['gateway' => $gateway, 'amount' => $amount])) echo $__env->make('braintree::disposit',['gateway' => $gateway, 'amount' => $amount], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                <?php elseif($gateway->method == 'Mollie'): ?>
                                                                    <?php if ($__env->exists('mollie::deposit',['gateway' => $gateway, 'amount' => $amount])) echo $__env->make('mollie::deposit',['gateway' => $gateway, 'amount' => $amount], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                <?php elseif($gateway->method == 'Flutterwave'): ?>
                                                                    <?php if ($__env->exists('flutterwave::deposit',['gateway' => $gateway, 'amount' => $amount])) echo $__env->make('flutterwave::deposit',['gateway' => $gateway, 'amount' => $amount], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                <?php elseif($gateway->method == 'Jazz Cash'): ?>
                                                                    <?php if ($__env->exists('jazzcash::deposit',['gateway' => $gateway, 'amount' => $amount])) echo $__env->make('jazzcash::deposit',['gateway' => $gateway, 'amount' => $amount], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                <?php elseif($gateway->method == 'Coinbase'): ?>
                                                                    <?php if ($__env->exists('coinbase::deposit',['gateway' => $gateway,'amount' => $amount])) echo $__env->make('coinbase::deposit',['gateway' => $gateway,'amount' => $amount], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                <?php elseif($gateway->method == 'AmazonPayment'): ?>
                                                                    <?php echo $__env->make("amazonpayment::_payment",['gateway' => $gateway, 'location' => 'deposit', 'amount' => $amount], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        ...
                                        <?php if(isset($records)): ?>
                                            <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($record->method=="Bank Payment"): ?>
                                                            <?php echo e(__('payment.Bank Payment')); ?>
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/components/deposit-page-section.blade.php ENDPATH**/ ?>