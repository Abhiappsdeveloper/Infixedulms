    ...
    <div class="d-flex align-items-center">
            ...
            <ul>
                ...
                <li class="notification_open">
                    <a href="#" class="notify_icon">
                        ...
                        <span class="notify_count <?php if($user->unreadNotifications->count()==0): ?> d-none <?php endif; ?>"></span>
                    </a>
                    <div class="notification_area">
                        <div class="notification_body">
                            <?php $__currentLoopData = $user->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e($notification->data['actionURL']??'#'); ?>"
                                   ...
                                   title="Mark As Read" data-notification_id="<?php echo e($notification->id); ?>">
                                    <div class="notyfy_content">
                                        <h4>  <?php echo strip_tags($notification->data['body']); ?></h4>
                            ...
                            <?php if($user->unreadNotifications->count()==0): ?>
                                <a href="#" class="single_nofy align-items-center justify-content-center">
                                    <div class="notyfy_content ">
                                        <h4> <?php echo e(__('frontend.No unread notification')); ?></h4>
                                    </div>
                        ...
                        <div class="notification_footer ">
                            <div class="d-flex align-items-center justify-content-between flex-wrap px-3">
                                ...
                                <a href="<?php echo e(route('myNotification')); ?>"
                                   class="readMore_text w-50  "><?php echo e(__('common.View All')); ?></a>

                                <a href="<?php echo e(route('NotificationMakeAllRead')); ?>"
                                   class="readMore_text  w-50"><?php echo e(__('common.Mark As Read')); ?></a>

                            </div>
                            <?php if(permissionCheck('myNotificationSetup')): ?>
                                <div class="d-flex align-items-center justify-content-center flex-wrap px-3">
                                    <a href="<?php echo e(route('myNotificationSetup')); ?>"
                                       class=" w-100  ">
                                        <i class="fas fa-cog"></i>
                                        <?php echo e(__('setting.Notification')); ?> <?php echo e(__('setting.Setup')); ?>
                ...
                <?php if(Settings('gamification_status') && Settings('gamification_leaderboard_status')): ?>
                    <li class="">
                        <button title=" <?php echo e(__('common.points')); ?>"
                            ...
                            <?php echo e($user->gamification_total_points - $user->gamification_total_spent_points); ?> </button>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
        <div class="profile_info collaps_part">
            ...
            <div class="profile_info_iner collaps_part_content">
                ...
                <?php if(isModuleActive('Affiliate') && $user->affiliate_request!=1): ?>
                ...
                <?php if(isModuleActive('UserType')): ?>
                    <?php $__currentLoopData = $user->userRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/partials/_dashboard_menu.blade.php ENDPATH**/ ?>