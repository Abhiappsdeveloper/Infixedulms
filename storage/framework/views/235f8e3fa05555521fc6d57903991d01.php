            ...
            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="instrucotr-item">
                    ...
                    <div class="instrucotr-item-content mx-auto text-center">
                        <h4>
                            <a href="<?php echo e(route('instructorDetails',[$instructor->id,Str::slug($instructor->name,'-')])); ?>"
                               class="currentColor"><?php echo e($instructor->name); ?></a>
                        </h4>
                        <p><?php echo e($instructor->headline); ?></p>
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/snippets/components/_single_instructor_v2.blade.php ENDPATH**/ ?>