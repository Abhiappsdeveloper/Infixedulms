    ...
    <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="testimonial-single  w-100 text-center">
            <div class="testimonial-top d-inline-block mx-auto">
                ...
                <span class="d-block"><?php echo e(__('frontend.Course Quality')); ?></span>
            ...
            <div class="testimonial-user text-center">
                <div class="testimonial-user-img mx-auto mb-1">
                    <img src="<?php echo e(getProfileImage($testimonial->image,$testimonial->author)); ?>"
                         alt="<?php echo e($testimonial->author); ?>">
                </div>
                <span><?php echo e(@$testimonial->profession); ?></span>
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/snippets/components/_single_testimonial_v3.blade.php ENDPATH**/ ?>