            ...
            <div class="img bg1">
                ...
                <?php if(!Settings('hide_social_share_btn') =='1'): ?>
                    <ul class="social-links">
                        <li><a href="<?php echo e($instructor->facebook); ?>"><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href="<?php echo e($instructor->twitter); ?>"><i class="fab fa-twitter"></i></a></li>
                        <li><a href="<?php echo e($instructor->linkedin); ?>"><i class="fab fa-linkedin"></i></a></li>
                        <li><a href="<?php echo e($instructor->youtube); ?>"><i class="fab fa-youtube"></i></a></li>
                    </ul>
                <?php endif; ?>
            </div>
            <h3 class="member-name"><?php echo e($instructor->name); ?></h3>
            <div class="designation"><?php echo e($instructor->headline); ?></div>
        </div>
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/snippets/components/_single_instructor_v7.blade.php ENDPATH**/ ?>