    ...
    <div class="category-slider owl-carousel">
        <?php if(isset($result )): ?>
            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('courses')); ?>?category_id[]=<?php echo e($category->id); ?>" class="category-item">
                     <div class="category-item-icon">
                        <img src="<?php echo e(asset($category->image)); ?>" alt="">
                    </div>
                    <div class="category-item-content">
                        <h6 class="fw-500 lh-1 mb-2 mb-0"><?php echo e($category->name); ?></h6>
                        <p class="lh-1 fs-12"><?php echo e(translatedNumber($category->total_courses)); ?> <?php echo e(__('frontend.Courses')); ?></p>
                    </div>
                </a>
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/snippets/components/_single_category_v2.blade.php ENDPATH**/ ?>