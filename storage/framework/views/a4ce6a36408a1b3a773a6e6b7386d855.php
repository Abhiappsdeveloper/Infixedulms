...
<link rel="stylesheet" href="<?php echo e(asset('public/frontend/infixlmstheme/css/homepageV7/header-v7.css')); ?>">
            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-3">
                        <a href="<?php echo e(url('/')); ?>" class="heading-logo d-block">
                            <img src="<?php echo e(getLogoImage(Settings('logo') )); ?>" class="home d-block" alt="Infix LMS">
                        </a>
                                ...
                                <form action="<?php echo e(route('search')); ?>">
                                    ...
                                    <div class="form-box">
                                        ...
                                        <input type="text" name="query" id="search" class="form-control"
                                               placeholder="<?php echo e(__('frontend.What are you looking for?')); ?>"
                                               required="">
                                    </div>
                                </form>
                            </div>
                            ...
                            <ul class="heading-nav">
                                ...
                                <?php if(isset($menus)): ?>
                                    <?php $__currentLoopData = $menus->where('parent_id',null); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <li class="heading-list <?php if($menu->mega_menu==1): ?> position-static <?php else: ?> <?php if($menu->show==1): ?> right_control_submenu <?php endif; ?> <?php endif; ?>">
                                            <a class="heading-links" <?php if($menu->is_newtab==1): ?> target="_blank"
                        ...
                        <div class="heading-end d-flex align-items-center justify-content-end gap-2 gap-lg-3">
                            <?php if(Settings('frontend_language_translation') == 1): ?>
                                ...
                                <div class="language dropdown">
                                    <button class="btn dropdown-toggle p-0 border-0" type="button"
                                        ...
                                        <span><?php echo e($currentLang); ?></span>
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <?php $__currentLoopData = getLanguageList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a class="dropdown-item" href="<?php echo e(route('changeLanguage',$language->code)); ?>">
                            ...
                            <?php if(Settings('show_cart')==1): ?>
                                ...
                                <div class="heading-cart-icon cart_store ">
                                    ...
                                    <span class="heading-cart-items notify_count"><?php echo e(@cartItem()); ?></span>
                                </div>
                                <!-- cart end -->
                            <?php endif; ?>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
    <div class="offcanvas-header d-flex justify-content-between">
        <a href="<?php echo e(url('/')); ?>" class="heading-logo d-block">
            <img src="<?php echo e(getLogoImage(Settings('logo') )); ?>" alt="Infix LMS">
        </a>
        ...
        <ul class="heading-nav">
            ...
            <?php if(isset($menus)): ?>
                <?php $__currentLoopData = $menus->where('parent_id',null); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li class="heading-list <?php if($menu->mega_menu==1): ?> position-static <?php else: ?> <?php if($menu->show==1): ?> right_control_submenu <?php endif; ?> <?php endif; ?>">
                        <a class="heading-links" <?php if($menu->is_newtab==1): ?> target="_blank"
                           <?php endif; ?> href="<?php echo e(getMenuLink($menu)); ?>">
            ...
            <li class="heading-list mt-4">
                <a href="<?php echo e(route('login')); ?>" class="theme-btn bg-transparent">
                    ...
                    <span><?php echo e(__('frontend.Login')); ?></span>
                </a>
                <a href="<?php echo e(route('register')); ?>" class="theme-btn bg-transparent">
                    <svg width="17" height="20" viewBox="0 0 17 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M13.7531 11.9975C14.9954 11.9975 16.0023 13.0044 16.0023 14.2468V14.8223C16.0023 15.7167 15.6827 16.5817 15.1011 17.2612C13.5314 19.095 11.1439 20 7.99791 20C4.85146 20 2.46502 19.0947 0.898441 17.2601C0.318577 16.5811 0 15.7174 0 14.8245V14.2468C0 13.0044 1.00703 11.9975 2.24927 11.9975H13.7531ZM13.7531 13.4977H2.24927C1.83561 13.4977 1.50027 13.8331 1.50027 14.2468V14.8245C1.50027 15.3603 1.69141 15.8785 2.03933 16.2858C3.29286 17.7538 5.25909 18.4997 7.99791 18.4997C10.7367 18.4997 12.7047 17.7538 13.9614 16.2856C14.3103 15.8779 14.5021 15.3589 14.5021 14.8223V14.2468C14.5021 13.8331 14.1667 13.4977 13.7531 13.4977ZM7.99791 0C10.7598 0 12.9988 2.23898 12.9988 5.00089C12.9988 7.76282 10.7598 10.0018 7.99791 10.0018C5.23597 10.0018 2.997 7.76282 2.997 5.00089C2.997 2.23898 5.23597 0 7.99791 0ZM7.99791 1.50027C6.06457 1.50027 4.49726 3.06756 4.49726 5.00089C4.49726 6.93424 6.06457 8.50154 7.99791 8.50154C9.93126 8.50154 11.4985 6.93424 11.4985 5.00089C11.4985 3.06756 9.93126 1.50027 7.99791 1.50027Z"
                            fill="currentColor"></path>
                    </svg>
                    <span><?php echo e(__('frontend.Sign Up')); ?></span>
                </a>
            </li>
        </ul>
    </div>
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/partials/header/2.blade.php ENDPATH**/ ?>