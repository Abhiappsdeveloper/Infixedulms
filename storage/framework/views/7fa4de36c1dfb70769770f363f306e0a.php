                ...
                <a href="<?php echo e(route('courses')); ?>?category_id[]=<?php echo e($category->id); ?>"
                   class="category-item">
                    ...
                    <div class="category-item-content">
                        <h6 class="fw-500 lh-1"><?php echo e($category->name); ?></h6>
                        <p class="lh-1 fs-12">
                            <?php echo e(translatedNumber($category->total_courses)); ?> <?php echo e(__('frontend.Courses')); ?>
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/snippets/components/_single_category_v3.blade.php ENDPATH**/ ?>