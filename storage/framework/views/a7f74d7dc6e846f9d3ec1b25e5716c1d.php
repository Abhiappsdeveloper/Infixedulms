<?php use Modules\StudentSetting\Entities\Institute; ?>
            ...
            <div class="login_wrapper_content">
                ...
                <form action="<?php echo e(route('register')); ?>" method="POST" id="regForm">
                    ...
                    <div class="row">
                        ...
                        <?php if($custom_field->show_phone): ?>
                            <div class="col-12 mt_20">
                                <div class="input-group custom_group_field">
                                    <input type="text" class="form-control ps-0"
                        ...
                        <?php if($custom_field->show_institute): ?>
                            <div class="col-xl-12">
                                <div class="short_select mt-3">
                                    <div class="row">
                                        <div class="col-xl-5">
                                            <h5 class="mr_10 font_16 f_w_500 mb-0"><?php echo e(__('common.choose_institute')); ?> <?php echo e($custom_field->required_institute ? '*' : ''); ?></h5>
                                        </div>
                                        <div class="col-xl-7">
                                            <select class="small_select w-100"
                                                    name="institute_id">
                                                <option
                                                    value=""><?php echo e(__('common.select_one')); ?></option>
                                                <?php $__currentLoopData = Institute::where('status',1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <span class="text-danger" role="alert"><?php echo e($errors->first('institute_id')); ?></span>
                        ...
                        <?php if(isModuleActive('Affiliate')): ?>
                            <div class="col-12 mt_20">
                                <div class="input-group custom_group_field">
                                    <input type="text" class="form-control ps-0"
                                           placeholder="<?php echo e(__('affiliate.Referral Code')); ?> (<?php echo e(__('frontend.Optional')); ?>)"
                                           name="referral_code" value="<?php echo e(old('referral_code')); ?>">
                                </div>
                                <span class="text-danger" role="alert"><?php echo e($errors->first('referral_code')); ?></span>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="col-12 mt_20">
                            <?php if(saasEnv('NOCAPTCHA_FOR_REG')=='true'): ?>
...
<?php echo $__env->make(theme('auth.layouts.app'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/auth/register.blade.php ENDPATH**/ ?>