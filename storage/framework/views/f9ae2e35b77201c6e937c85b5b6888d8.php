...
<?php endif; ?>
    ...
    <?php echo $__env->make(theme('partials.footer.'.$footer_style), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
    ...
    <script async
            defer src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(Settings('gmap_key')); ?>"></script>
    ...
    <?php if(auth()->guard()->check()): ?>
        <?php if(Auth::user()->role_id==3 && ((int)Settings('device_limit_time')) > 0): ?>
            <script>
                let start = false;
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/partials/_footer.blade.php ENDPATH**/ ?>