                    ...
                    <div class="quiz-item w-100 mt-0">
                        ...
                        <div class="quiz-item-lession d-grid">
                            ...
                            <p class="fw-bold flex-grow-1 text-center">
                                ...
                                ?>
                                <?php echo e(MinuteFormat($duration)); ?>
                            ...
                            <p class="fw-bold flex-grow-1 text-center">
                                ...
                                <?php echo e(translatedNumber((string)$quiz->quiz->total_questions)); ?>  <?php echo e(__('frontend.Questions')); ?>
                            ...
                            <p class="fw-bold flex-grow-1 text-center">
                                ...
                                <?php echo e(translatedNumber((string)$quiz->quiz->total_marks)); ?> <?php echo e(__('quiz.Marks')); ?>
                        ...
                        <div class="quiz-item-content">
                            <span class="quiz-item-content-meta fw-500 mb-1">
                                ...
                                <?php echo e($quiz->quiz->category->name); ?> - <span><?php echo e(__('quiz.Quiz')); ?></span>
                            ...
                            <a class="quiz-item-title" data-bs-toggle="tooltip" data-bs-placement="bottom"
                               ...
                               href="<?php echo e(courseDetailsUrl(@$quiz->id,@$quiz->type,@$quiz->slug)); ?>">
                                <h4 class="currentColor mb-0"><?php echo e($quiz->title); ?></h4>
                            </a>
                            <div class="quiz-item-price d-flex flex-wrap align-items-center justify-content-between">
                                <?php if(auth()->check() && $quiz->isLoginUserEnrolled): ?>
                                    <a href="<?php echo e(courseDetailsUrl(@$quiz->id,@$quiz->type,@$quiz->slug)); ?>"
                                       class="theme-btn">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e(route('buyNow',[@$quiz->id])); ?>"
                                       class="theme-btn">
                                ...
                                <span>
                                    <?php if(showEcommerce()): ?>
                                        <?php if(@$quiz->discount_price!=null): ?>
                                            <del class="me-3">        <?php echo e(getPriceFormat($quiz->price)); ?></del>
                                        <?php endif; ?>
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/snippets/components/_single_quiz_v2.blade.php ENDPATH**/ ?>