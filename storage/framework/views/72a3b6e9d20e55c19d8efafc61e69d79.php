        ...
        <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="blog-single bg-white">
                <div class="blog-single-img">
                    <a href="<?php echo e(route('blogDetails',[$blog->slug])); ?>" class="d-block w-100 h-100">
                        <img src="<?php echo e(getBlogImage($blog->thumbnail)); ?>" alt="">
                    </a>
                    <?php if($blog->category && $blog->category->title): ?>
                        <span class="blog-single-meta fw-bold"><?php echo e($blog->category->title); ?></span>
                    <?php endif; ?>
                ...
                <div class="blog-single-rating">
                    <div class="mb-4 p-2 d-flex align-items-center justify-content-between flex-wrap bg-white">
                        ...
                        <a href="#" class="d-flex align-items-center">
                            <div class="user">
                                <img src="<?php echo e(getProfileImage($blog->user->image, $blog->user->name)); ?>" alt="">
                            </div>
                            <span class="user-content fw-500 ps-2"><?php echo e($blog->user->name); ?> </span>
                        </a>
                        <div class="date text-end">
                            <span
                                class="text-primary fw-500"><?php echo e(showDate(@$blog->authored_date )); ?> <?php echo e(translatedNumber($blog->authored_time)); ?></span>
                        </div>
                    </div>
                </div>
                <div class="blog-single-content pt-0">
                    <h4 class="fw-500">
                        <a href="<?php echo e(route('blogDetails',[$blog->slug])); ?>" class="currentColor" data-bs-toggle="tooltip"
                           data-bs-placement="bottom" title="<?php echo e($blog->title); ?>">
                            <?php echo e($blog->title); ?>

                        </a>
                    </h4>
                    <p><?php echo \Illuminate\Support\Str::limit(strip_tags($blog->description),200); ?></p>
                    <a href="<?php echo e(route('blogDetails',[$blog->slug])); ?>"
                       class="theme-btn fw-500"><?php echo e(__('common.Read More')); ?></a>
                </div>
            </div>
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/snippets/components/_single_blog_v2.blade.php ENDPATH**/ ?>