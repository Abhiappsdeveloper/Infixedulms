<div data-type="component-text"
    ...
    <link rel="stylesheet" href="<?php echo e(themeAsset('css/homepageV7/cta-v7.css')); ?>">
            ...
            <div class="col-md-6">
                <div class="cta-section d-flex align-items-center bg1">
                    <div class="cta-section-content">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="theme-btn">Join now</a>
                    </div>
                    <div class="cta-section-img align-self-end">
                        <img src="<?php echo e(themeAsset('img/cta/cta-1-default.png')); ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="cta-section d-flex align-items-center bg2">
                    <div class="cta-section-content">
                        ...
                        <p class="lh-base">With our interactive courses, you may explore an infinite array of learning
                            possibilities from thought</p>
                        <a href="<?php echo e(route('becomeInstructor')); ?>" class="theme-btn">Join now</a>
                    </div>
                    <div class="cta-section-img align-self-end">
                        <img src="<?php echo e(themeAsset('img/cta/cta-2-default.png')); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/snippets/components/_home_page_cta_section_v7.blade.php ENDPATH**/ ?>