...
<link rel="stylesheet" href="<?php echo e(asset('public/frontend/infixlmstheme/css/homepageV7/footer-v7.css')); ?>">
<?php
...
?>
<footer
    class="footer footer2 <?php echo e(Settings('footer_show')==0?'d-none d-sm-none d-md-block d-lg-block d-xl-block':''); ?> position-relative overflow-hidden section-margin">
    <div class="container">
        <div class="row">
            <div class="col-xl-4 col-md-8">
                <div class="pe-md-5">
                    <div class="footer-item">
                        <h5><?php echo e(__('frontend.About Company')); ?></h5>
                        <p>
                            <?php echo e(function_exists('footerSettings')?footerSettings('footer_about_description'):''); ?>
                    ...
                    <?php if($newsletterSetting->home_status==1): ?>
                        ...
                        <div class="footer-subscribe">
                            <h5><?php echo e(__('frontend.Never Miss A Post!')); ?></h5>
                            <p><?php echo e(__('frontend.Choose the most powerful courses and always be on demand')); ?></p>
                            <form action="<?php echo e(route('subscribe')); ?>"
                                ...
                                <div class="form-box d-flex flex-wrap align-items-center gap-2">
                                    ...
                                    <input type="submit" class="form-control text-uppercase"
                                           value="<?php echo e(__('frontend.Subscribe')); ?>">
                                    <div class="info">
            ...
            <?php if(isset($sectionWidgets)): ?>
                <?php if(count($sectionWidgets['one'])!=0): ?>
                    <div class="col-xl-3 col-md-4 col-sm-6">
                        <div class="footer-item">
                            <h5><?php echo e(function_exists('footerSettings')?footerSettings('footer_section_one_title'):''); ?></h5>
                            <ul>
                ...
                <?php if(count($sectionWidgets['two'])!=0): ?>
                    <div class="col-xl-3 col-md-4 col-sm-6">
                        <div class="footer-item">
                            <h5><?php echo e(function_exists('footerSettings')?footerSettings('footer_section_two_title'):''); ?></h5>
                            <ul>
                ...
                <?php if(count($sectionWidgets['three'])!=0): ?>
                    <div class="col-xl-2 col-md-4 col-sm-6">
                        <div class="footer-item">
                            <h5><?php echo e(function_exists('footerSettings')?footerSettings('footer_section_three_title'):''); ?></h5>
                            <ul>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-sm-6">
                            <div class="contact d-flex align-items-center">
                                ...
                                <div class="content">
                                    <span
                                        class="fw-bold fs-14 text-uppercase d-block"><?php echo e(__('frontend.Call Us 24/7')); ?></span>
                                    <a href="tel:<?php echo e(Settings('phone')); ?>" class="currentColor"><?php echo e(Settings('phone')); ?></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <span class="d-block fs-14 fw-500"><?php echo e(Settings('address')); ?></span>
                            <a href="mailto:<?php echo e(Settings('email')); ?>" class="currentColor fs-20"><?php echo e(Settings('email')); ?></a>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <div class="ps-lg-5">
                                <h4 class="text-uppercase currentColor"><?php echo e(__('frontend.Follow Us')); ?></h4>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <h4 class="text-uppercase currentColor"><?php echo e(__('frontend.Payment Method')); ?></h4>
                            <?php $__currentLoopData = $payment_methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <img src="<?php echo e(asset($method->logo)); ?>" class="payment-methods" alt="<?php echo e($method->method); ?>">
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/partials/footer/2.blade.php ENDPATH**/ ?>