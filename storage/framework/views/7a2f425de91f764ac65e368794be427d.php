                ...
                <div class="quiz-item w-100 mt-0">
                    ...
                    <div class="quiz-item-lession d-grid">
                        ...
                        <p class="fw-bold flex-grow-1 text-center">
                            ...
                            <?php echo e(translatedNumber($quiz->quiz->total_questions)); ?>  <?php echo e(__('frontend.Questions')); ?>
                        ...
                        <p class="fw-bold flex-grow-1 text-center">
                            ...
                            <?php echo e(translatedNumber($quiz->quiz->total_marks)); ?> <?php echo e(__('quiz.Marks')); ?>
                   ...
                   <?php echo e($quiz->quiz->category->name); ?> - <span><?php echo e(__('quiz.Quiz')); ?></span>
                        ...
                        <div class="quiz-item-info mb-3">
                            <span class="d-inline-block me-2">
                                ...
                                <?php echo e($quiz->courseLevel->title); ?>

                            </span>
                            <?php if(!Settings('hide_total_enrollment_count') == 1): ?>
                                <span class="d-inline-block"><i
                                        class="fa fa-graduation-cap me-1"></i><?php echo e($quiz->total_enrolled); ?> <?php echo e(__('frontend.Students')); ?></span>
                            <?php endif; ?>
                        </div>
                        <a class="quiz-item-title" data-bs-toggle="tooltip" data-bs-placement="bottom"
                           title="<?php echo e($quiz->title); ?>" href="<?php echo e(courseDetailsUrl(@$quiz->id,@$quiz->type,@$quiz->slug)); ?>">
...
<?php /**PATH /home/u709483251/domains/infixedulms.madhutechnoworld.in/public_html/resources/views/frontend/infixlmstheme/snippets/components/_single_quiz_v4.blade.php ENDPATH**/ ?>